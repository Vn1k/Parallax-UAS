    ...
    return(
       ...
       <div id="Footer">
        <section id="footer">
            ...
            <div id="footer2">
                <div>
                    <p data-aos="fade-right" data-aos-easing="ease-out-sine" data-aos-offset="10" data-aos-anchor-placement="top-center" id="Ref1">AnimeJS</p>
                </div>
                <div>
                    <p data-aos="fade-right" data-aos-easing="ease-out-sine" data-aos-offset="10" data-aos-anchor-placement="top-center" id="Ref2">TailwindCSS</p>
                </div>
                <div>
                    <p data-aos="fade-right" data-aos-easing="ease-out-sine" data-aos-offset="10" data-aos-anchor-placement="top-center" id="Ref3">Animation On Scroll</p>
                </div>
                <div>
                    <p data-aos="fade-right" data-aos-easing="ease-out-sine" data-aos-offset="10" data-aos-anchor-placement="top-center" id="Ref4">Font Awesome Icon</p>  
                </div>
                <div>
                    <p data-aos="fade-left" data-aos-easing="ease-out-sine" data-aos-offset="10" data-aos-anchor-placement="top-center" id="Ref5">Camille Mormal</p>  
                </div>
                <div>
                    <p data-aos="fade-left" data-aos-easing="ease-out-sine" data-aos-offset="10" data-aos-anchor-placement="top-center" id="Ref6">Route</p>  
                </div>            
            </div>
            </section>
       </div> 
